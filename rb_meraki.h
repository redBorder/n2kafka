...
int parse_meraki_secrets(struct meraki_database *db, const struct json_t *meraki_object,char *err,size_t errsize);
...
void meraki_decode(char *buffer,size_t buf_size,void *listener_callback_opaque);
